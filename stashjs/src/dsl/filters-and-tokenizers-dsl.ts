...
export type TokenFilter = NgramTokenizer | DowncaseFilter | UpcaseFilter

export type Tokenizer = StandardTokenizer | NgramTokenizer

export const downcase: DowncaseFilter = { kind: "downcase" }
export const upcase: UpcaseFilter = { kind: "upcase" }

export const ngram: (config: NgramTokenizerConfig) => NgramTokenizer = config => ({ kind: "ngram", ...config })

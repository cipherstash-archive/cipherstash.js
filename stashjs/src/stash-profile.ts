...
export class StashProfile {
  ...
  private makeDataServiceCredentialsAuthStrategy(): AuthStrategy<OauthAuthenticationInfo> {
    switch (this.config.identityProvider.kind) {
      ...
      case "OAuthCallback": return new OAuthCallbackStrategy(this as StashProfileOAuthCallback)
      case "Console-AccessKey": return new ConsoleAccessKeyStrategy(this as StashProfileConsoleAccessKey)
    }
  }
